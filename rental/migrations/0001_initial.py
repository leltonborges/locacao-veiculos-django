# Generated by Django 5.2 on 2025-05-29 22:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_alocacao', models.DateTimeField(verbose_name='Data de Alocação')),
                ...
                ('km_estimado', models.PositiveIntegerField(blank=True, help_text='Estimativa de quilômetros a serem rodados', null=True, verbose_name='Quilômetros a Rodar')),
                ('km_final', models.PositiveIntegerField(blank=True, help_text='Quilômetros efetivamente rodados', null=True, verbose_name='Quilômetros Rodados')),
